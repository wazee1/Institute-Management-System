<%-- 
    Document   : TimeTableHome
    Created on : Sep 25, 2018, 9:44:56 AM
    Author     : jahrin
--%>
...
<html>
    ...
    <center>
        <img src="IMG/time_1.jpg" width="200" height="200">
            ...
            <tbody>
                ...
                <td>
                    <a href="TimeTables.jsp">
                        <input type="submit" value="LECTURE TIME TABLES" name="insert"/>
                    </a>
                            ...
                            <a href="">
                        <input type="submit" value="EXAM TIMETABLES" name="insert" />
                    </a>
